...
public class InvocationLogManagerRequest {
	...
	public InvocationLogManagerRequest(final LoggerRequestType requestType, final String functionLink) {
		this.requestType = requestType;
		this.functionLink = functionLink;
	}

	public InvocationLogManagerRequest(final LoggerRequestType requestType, final int executionId) {
		this.requestType = requestType;
		this.executionId = executionId;
	}

	public InvocationLogManagerRequest(final LoggerRequestType requestType, final Execution execution,
	...
	public InvocationLogManagerRequest(final LoggerRequestType requestType, final Invocation invocation,
			final int executionId) {
		this.requestType = requestType;
	...
	public InvocationLogManagerRequest(final LoggerRequestType requestType) {
		this.requestType = requestType;
	}
	...
	public void setRequestType(final LoggerRequestType requestType) {
		this.requestType = requestType;
	}
